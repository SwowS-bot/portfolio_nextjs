...
export default function AboutDesignerSection() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="about-designer-scroll-container"
    >
      {/* Base Section - Always visible */}
      <div className="about-designer base-section">
        <div className="about-designer-wrapper">
          {/* Left Section */}
          <div className="about-designer-left side-60">
            <span className="label-l c-light-grey uppercase">Base Layer</span>
            
            <h2 className="h2 c-white my-1.2 mb-3.2 desktop:my-8 max-w-[69.6rem]">
              Scroll to Reveal
            </h2>

            <div className="about-designer__interest-list">
              <span className="p-l c-white-50">Initial State</span>
              <span className="p-l c-white-50">Base Layer</span>
              <span className="p-l c-white-50">Scroll Effect</span>
            </div>
          </div>
      ...
      {/* Overlay Section - Reveals on scroll */}
      <div 
        ref={overlayRef}
        className="about-designer overlay-section"
        style={{ clipPath: 'inset(100% 0% 0% 0%)' }}
      >
        <div className="about-designer-wrapper">
          {/* Left Section */}
          <div className="about-designer-left side-60">
            <span className="label-l c-light-grey uppercase">About the Designer</span>
            ...
            <div className="about-designer__interest-list">
              <span className="p-l c-white-50">Design Enthusiast</span>
              <span className="p-l c-white-50">Creative Thinker</span>
              <span className="p-l c-white-50">Problem Solver</span>
            </div>
          </div>
          ...
          <div className="about-designer-right side-40">
            ...
            <div className="about-designer-right__bg">
              <Image
                src="/images/home-portrait-hover.e0k4yrfz.webp"
                alt="About designer"
                fill
                sizes="(max-width: 800px) 100vw, 40vw"
                className="object-cover"
          ...
          <div className="about-designer__card bg-white flex flex-col items-center justify-between p-8 max-w-sm w-full mx-auto relative z-10">
            <div className="card-item text-center mb-6">
              ...
              <h3 className="h3 text-black text-4xl font-light mt-2">10+</h3>
            </div>

            <div className="card-item text-center mb-6">
              <h3 className="h3 text-black text-4xl font-light mb-2">100+</h3>
            ...
            <div className="card-item text-center">
              ...
              <h3 className="h3 text-black text-4xl font-light mt-2">50+</h3>
            </div>
          </div>
